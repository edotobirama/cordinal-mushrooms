...
export default function ProductionPage() {
    ...
    const refreshData = async () => {
        ...
        try {
            ...
            // Sort manually
            batches.sort((a: any, b: any) => new Date(b.startDate).getTime() - new Date(a.startDate).getTime());

            setActiveBatches(batches);

            // 2. Fetch Available Racks
            ...
            console.error("Fetch Production Erorr", e);
        } finally {
            setLoading(false);
        }
    };
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Monitor active batches and lifecycles.
                    </p>
                </div>
